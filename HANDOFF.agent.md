...
- C: `1.1.0`へP1〜P8を統合済み。P2=A1〜A3、P1=C1〜C11(+A4・A5)、P3=B1〜B4(+TDZホットフィックス)、
...
- C: 2026-08-07 — evidence: status=PASS; kind=compile; command=node --check をextensionとtestの
  全.jsへ実行(P8実装後); counts=passed=16, failed=0, skipped=0, not-run=0
- C: 2026-08-07 — evidence: status=PASS; kind=runtime; command=/test/index.html をライト・ダーク
